        ...
        <div class="modal-content">
            ...
            <form action="index.php?act=checkout" method="post" onsubmit="return validateCheckoutForm()">
                ...
                <div class="modal-body">
                    <div id="checkout-errors" class="alert alert-danger d-none"></div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" id="phone" name="phone"
                            value="<?= htmlspecialchars($user['phone'] ?? '') ?>" pattern="[0-9]{9,12}">
                    </div>
...
function validateCheckoutForm() {
    ...
    if (!phone || !/^\d{9,12}$/.test(phone)) errors.push("Số điện thoại phải từ 9–12 chữ số.");
    if (!address) errors.push("Vui lòng nhập địa chỉ nhận hàng.");
    if (!payment) errors.push("Vui lòng chọn phương thức thanh toán.");
...
document.querySelector('form[action="index.php?act=updateCart"]').addEventListener("submit", function(e) {
    let valid = true;
    document.querySelectorAll(".quantity-input").forEach(input => {
