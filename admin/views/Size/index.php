                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="hstack gap-3 flex-wrap justify-content-end">
                                                        <a href="index.php?act=admin_size_edit&id=<?= $comment->id ?>"
                                                            class="btn btn-sm btn-warning"><i
                                                                class="ri-pencil-line"></i> Sửa</a>

                                                        <a href="index.php?act=admin_size_delete&id=<?= $comment->id ?>"
                                                            onclick="return confirm('Xóa size này?')"
                                                            class="btn btn-sm btn-danger"><i
                                                                class="ri-delete-bin-line"></i> Xóa</a>

                                                        <?php if ($comment->status === 1): ?>
                                                        <a href="index.php?act=admin_size_toggle&id=<?= $comment->id ?>&status=0"
                                                            class="btn btn-sm btn-secondary"><i
                                                                class="ri-eye-off-line"></i> Ẩn</a>
                                                        <?php else: ?>
                                                        <a href="index.php?act=admin_size_toggle&id=<?= $comment->id ?>&status=1"
                                                            class="btn btn-sm btn-success"><i class="ri-eye-line"></i>
                                                            Hiện</a>
                                                        <?php endif; ?>
