                                ...
                                <div class="d-flex align-items-center gap-md-2">
                                    <form action="index.php" method="get" class="d-flex align-items-center">
                                        ...
                                        <div class="search-box me-2">
                                            <input type="text" class="form-control" placeholder="Tìm kiếm sản phẩm..." name="keyword" value="<?= htmlspecialchars($_GET['keyword'] ?? '') ?>">
                                            <i class="ri-search-line search-icon"></i>
                                        </div>
                                        <button type="submit" class="btn btn-primary"><i class="ri-search-line"></i></button>
                                    </form>
                                    <a href="index.php?act=addProduct" class="btn btn-success"><i class="ri-add-line align-bottom me-1"></i> Thêm mới</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <?php foreach ($listProducts as $product): ?>
                                                        <tr>
                                                            <td class="text-center">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="selected[]" value="<?= htmlspecialchars($product->id) ?>">
