...
class CartController
{
    ...
    public function addToCart()
    {
        ...
        if ($product->stock < $quantity) {
            $_SESSION['add_to_cart_error'] = "Sản phẩm '{$product->name}' chỉ còn lại {$product->stock} cái. Vui lòng chọn số lượng ít hơn.";
    ...
    public function placeOrder()
    {
        ...
        foreach ($cartItems as $item) {
            ...
            $this->orderModel->decreaseStock($item->product_id, $item->quantity);
        }
        // Xóa giỏ hàng
